...
def generate_recommendations(crew, symptoms, medical_history):
    try:
        return crew.kickoff(inputs={"symptoms": symptoms, "medical_history": medical_history})
...
if st.button("Get Diagnosis and Treatment Plan"):
    with st.spinner('Generating recommendations...'):
        result = generate_recommendations(crew, symptoms, medical_history)
        if result:
            st.write(result)
